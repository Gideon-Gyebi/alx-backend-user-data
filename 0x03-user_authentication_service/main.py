...
def register_user(email: str, password: str) -> None:
    """
    Testing for register a user with the given email and password.
    Args:
...
def log_in_wrong_password(email: str, password: str) -> None:
    """
    Testing for log in with the given wrong credentials.
    Args:
        email: Is the he email of the user.
        password: Is the password of the user.
    Returns:
        None
    """
...
def log_in(email: str, password: str) -> str:
    """
    Testing for log in with the given correct email and password.
    Args:
        email: Is the email of the user.
        password: Is the password of the user.
    Returns:
...
def profile_logged(session_id: str) -> None:
    """
    Testing for profile with being logged in with session_id.
    Args:
        session_id: Is he session_id of the user.
    Returns:
        None
    """
...
def log_out(session_id: str) -> None:
    ...
    Args:
        session_id: Is the session_id of the user.
    Returns:
        None
    """
    cookies = {'session_id': session_id}
...
def update_password(email: str, reset_token: str,
    ...
    """
    Testing for update password with the given email,
    reset_token and new_password.
    Args:
        email: Is the email of the user.
        reset_token: Is the reset_token of the user.
